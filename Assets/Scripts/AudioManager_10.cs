...
public class AudioManager_10 : MonoBehaviour
{
    ...
    private static AudioManager_10 _instance;                  //
    public static AudioManager_10 instance                     //
    {                  
        get {                                               //

            if (_instance == null) {                                //

                _instance = FindObjectOfType<AudioManager_10>();       //

                GameObject gameO=null;
                if (_instance == null)                              //
                {
                    gameO = new GameObject("AudioManager");        //
                    gameO.AddComponent<AudioManager_10>();             //
                    _instance = gameO.GetComponent<AudioManager_10>(); //
